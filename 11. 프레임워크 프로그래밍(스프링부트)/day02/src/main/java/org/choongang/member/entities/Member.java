...
public class Member extends BaseEntity {
   ...
   // @Lob
    ...
    @OneToMany(mappedBy = "member",cascade = {CascadeType.REMOVE,CascadeType.PERSIST},orphanRemoval=true)//DB의 제약 조건 CASCADE ON DELETE 는 아니다(제약 조건이 추가되는것이 아니다.) 자식을 제거하고 부모를 제거
