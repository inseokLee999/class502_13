...
public class Ex04 {
    public static void main(String[] args) {
        ...
        System.out.printf("str3 주소 : %d%n",System.identityHashCode(str3));
        System.out.printf("str1 == str2 : %s%n",str1==str2);
        System.out.printf("str1 == str3 : %s%n",str1==str3);
        System.out.printf("str1.equals(str2) : %s%n",str1.equals(str2));// String - equals 동등성 비교 재정의
        System.out.printf("str1.equals(str3) : %s%n",str1.equals(str3));
    }
}
